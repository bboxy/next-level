...
MNE Mne6502[] = {
    ...
    { NULL, v_mnemonic, "ahx", 0, AF_WORDADRY|AF_INDBYTEY, { 0x9f, 0x93 } },
    { NULL, v_mnemonic, "alr", 0, AF_IMM8, { 0x4b } },
    ...
    { NULL, v_mnemonic, "aso", 0, AF_BYTEADR|AF_BYTEADRX|AF_WORDADR|AF_WORDADRX|AF_WORDADRY|AF_INDBYTEX|AF_INDBYTEY, { 0x07, 0x17, 0x0f, 0x1f, 0x1b, 0x03, 0x13 } },
    { NULL, v_mnemonic, "asr", 0, AF_IMM8, { 0x4b } },
    { NULL, v_mnemonic, "axm", 0, AF_IMM8, { 0x8b } },
    { NULL, v_mnemonic, "axs", 0, AF_IMM8, { 0xcb } },
    ...
    { NULL, v_mnemonic, "crs", 0, AF_IMP, { 0x02 } },
    ...
    { NULL, v_mnemonic, "hlt", 0, AF_IMP, { 0x02 } },
    ...
    { NULL, v_mnemonic, "isc", 0, AF_BYTEADR|AF_BYTEADRX|AF_WORDADR|AF_WORDADRX|AF_WORDADRY|AF_INDBYTEX|AF_INDBYTEY, { 0xe7, 0xf7, 0xef, 0xff, 0xfb, 0xe3, 0xf3 } },
    { NULL, v_mnemonic, "jam", 0, AF_IMP, { 0x02 } },
    { NULL, v_mnemonic, "jmp", 0, AF_WORDADR|AF_INDWORD, { 0x4C, 0x6C } },
    { NULL, v_mnemonic, "jsr", 0, AF_WORDADR, { 0x20 } },
    { NULL, v_mnemonic, "kil", 0, AF_IMP, { 0x02 } },
    { NULL, v_mnemonic, "lae", 0, AF_WORDADRY, { 0xbb } },
    { NULL, v_mnemonic, "lar", 0, AF_WORDADRY, { 0xbb } },
    ...
    { NULL, v_mnemonic, "lse", 0, AF_BYTEADR|AF_BYTEADRX|AF_WORDADR|AF_WORDADRX|AF_WORDADRY|AF_INDBYTEX|AF_INDBYTEY, { 0x47, 0x57, 0x4f, 0x5f, 0x5b, 0x43, 0x53 } },
    ...
    { NULL, v_mnemonic, "tas", 0, AF_WORDADRY, { 0x9b } },
    ...
    { NULL, v_mnemonic, "xaa", 0, AF_IMM8, { 0x8b } },
    { NULL, }
};
